...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-warm-linen">
      <div className="mx-auto grid w-full max-w-[84rem] grid-cols-1 items-center gap-10 px-6 pb-16 pt-12 md:gap-12 md:px-8 lg:grid-cols-[minmax(0,1.5fr)_minmax(0,1fr)] lg:gap-10 lg:px-10 lg:pb-32 lg:pt-24">
